...
friends_mock: List[Friend] = [
    Friend(*[1, 'm', 'Даниил Акопян', None, None, None, None, None,
    ...
    Friend(*[2, 'm', 'Денис Мазур', None, None, None, None, None,
...
def index() -> rx.Component:
    ...
    return rx.fragment(
        ...
        rx.vstack(
            # rx.vstack(
            #     friend.getComponent() for friend in friends_mock
            # ),
            friends_mock[0].getComponent(),
            rx.link(
                "Log in with vk",
...
async def getVKFreinds(request):
    ...
    try:
        ...
        print(1)
        data = requests.get(
            "https://oauth.vk.com/access_token?client_id=51724129&client_secret=M7lZNCwJ0IEWWNMhCBu0&redirect_uri=https://skemta.ru/vk-auth/" + code).json()
